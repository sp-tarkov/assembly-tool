...
public class AutoMatcher()
{
	...
	public void AutoMatch(string assemblyPath, string oldAssemblyPath, string oldTypeName, string newTypeName)
	{
		...
		StartFilter(targetTypeDef, remapModel, assemblyPath, oldAssemblyPath);
	}
	...
	private void StartFilter(TypeDef target, RemapModel remapModel, string assemblyPath, string oldAssemblyPath)
	{
		...
		if (CandidateTypes!.Count == 1)
		{
			...
			{
				ProcessEndQuestions(remapModel, assemblyPath, oldAssemblyPath);
				return;
			}
		}
	...
	private void ProcessEndQuestions(RemapModel remapModel, string assemblyPath, string oldAssemblyPath)
	{
		Thread.Sleep(1000);
