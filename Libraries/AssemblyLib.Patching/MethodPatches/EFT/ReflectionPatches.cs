...
public class GeneralReflectionPatches
{
    ...
    /// </summary>
    [MethodPatch(typeof(DataProvider), nameof(DataProvider.GetDataContainersTypes), MethodPatchType.Replace)]
...
public class CommonEventDataCtorPatch : CommonEventData
{
    ...
    ///     Fixes reflection forcefully loading all assemblies into context
    /// </summary>
    [MethodPatch(typeof(CommonEventData), MethodPatchTargetKind.Constructor, MethodPatchType.Replace)]
    public void Patch()
    {
