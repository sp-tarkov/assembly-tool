...
using AssemblyLib.Patching.Patches;
using EFT;
...
[Injectable]
public class OnGameStartedCodeStub(MemberLookup lookup, MethodPatcher methodPatcher) : IModulePatch
{
    ...
    public void Patch()
    {
        ...
        var onGameStartedStub = lookup.Stub.Method<OnGameStartedPatch>("OnGameStarted");
