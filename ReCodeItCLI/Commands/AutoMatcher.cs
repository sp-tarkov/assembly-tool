...
public class AutoMatchCommand : ICommand
{
	...
	[CommandParameter(2, IsRequired = true, Description = "Path to your mapping file so it can be updated if a match is found")]
	...
	[CommandParameter(4, IsRequired = true, Description = "The name you want the type to be renamed to")]
