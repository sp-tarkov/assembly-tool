...
namespace AssemblyData.methodsrewriter
{
	class TypeInstanceResolver
	{
		...
		public FieldInfo Resolve(IField fieldRef)
		{
			...
			fieldRef = GenericArgsSubstitutor.Create(
				fieldRef,
				fieldRef.DeclaringType.TryGetGenericInstSig()
			);
		...
		public MethodBase Resolve(IMethod methodRef)
		{
			...
			methodRef = GenericArgsSubstitutor.Create(
				methodRef,
				methodRef.DeclaringType.TryGetGenericInstSig()
			);
