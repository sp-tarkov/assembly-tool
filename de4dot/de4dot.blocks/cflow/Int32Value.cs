...
namespace de4dot.blocks.cflow
{
	public class Int32Value : Value
	{
		...
		public static Int32Value Conv_U4(Int64Value a) =>
			new Int32Value((int)(uint)a.Value, (uint)a.ValidMask);
		...
		public static Int32Value Conv_I4(Int64Value a) =>
			new Int32Value((int)a.Value, (uint)a.ValidMask);
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 7) || (uint)a.Value > sbyte.MaxValue)
				return CreateUnknown();
			return Conv_I1(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 15) || (uint)a.Value > short.MaxValue)
				return CreateUnknown();
			return Conv_I2(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 8) || (uint)a.Value > byte.MaxValue)
				return CreateUnknownUInt8();
			return Conv_U1(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 16) || (uint)a.Value > ushort.MaxValue)
				return CreateUnknownUInt16();
			return Conv_U2(a);
		}
		...
		public static Int32Value And(Int32Value a, Int32Value b)
		{
			...
			return new Int32Value(
				av & bv,
				(am & bm) | (((uint)av & am) ^ am) | (((uint)bv & bm) ^ bm)
			);
		}
		...
		public static Bool3 CompareEq(Int32Value a, Int32Value b)
		{
			...
			if (ReferenceEquals(a, b))
				return Bool3.True;
			if (
				((uint)a.Value & a.ValidMask & b.ValidMask)
				!= ((uint)b.Value & a.ValidMask & b.ValidMask)
			)
				return Bool3.False;
