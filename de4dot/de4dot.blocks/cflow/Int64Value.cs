...
namespace de4dot.blocks.cflow
{
	public class Int64Value : Value
	{
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 7) || !a.CheckSign(NO_UNKNOWN_BITS << 7))
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 7) || (ulong)a.Value > (ulong)sbyte.MaxValue)
				return Int32Value.CreateUnknown();
			return Int32Value.Conv_I1(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 15) || !a.CheckSign(NO_UNKNOWN_BITS << 15))
				return Int32Value.CreateUnknown();
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 15) || (ulong)a.Value > (ulong)short.MaxValue)
				return Int32Value.CreateUnknown();
			return Int32Value.Conv_I2(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 31) || !a.CheckSign(NO_UNKNOWN_BITS << 31))
				return Int32Value.CreateUnknown();
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 31) || (ulong)a.Value > (ulong)int.MaxValue)
				return Int32Value.CreateUnknown();
			return Int32Value.Conv_I4(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 7) || a.Value < 0 || a.Value > byte.MaxValue)
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 8) || (ulong)a.Value > byte.MaxValue)
				return Int32Value.CreateUnknownUInt8();
			return Int32Value.Conv_U1(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 15) || a.Value < 0 || a.Value > ushort.MaxValue)
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 16) || (ulong)a.Value > ushort.MaxValue)
				return Int32Value.CreateUnknownUInt16();
			return Int32Value.Conv_U2(a);
		}
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 31) || a.Value < 0 || a.Value > uint.MaxValue)
				return Int32Value.CreateUnknown();
		...
		{
			if (!a.AreBitsValid(NO_UNKNOWN_BITS << 32) || (ulong)a.Value > uint.MaxValue)
				return Int32Value.CreateUnknown();
			return Int32Value.Conv_U4(a);
		}
		...
		public static Int64Value And(Int64Value a, Int64Value b)
		{
			long av = a.Value,
				bv = b.Value;
			ulong am = a.ValidMask,
				bm = b.ValidMask;
			return new Int64Value(
				av & bv,
				(am & bm) | (((ulong)av & am) ^ am) | (((ulong)bv & bm) ^ bm)
			);
		}
		...
		public static Int64Value Shl(Int64Value a, Int32Value b)
		{
			...
			int shift = b.Value;
			ulong validMask =
				(a.ValidMask << shift) | (ulong.MaxValue >> (sizeof(long) * 8 - shift));
		...
		public static Bool3 CompareEq(Int64Value a, Int64Value b)
		{
			...
			if (ReferenceEquals(a, b))
				return Bool3.True;
			if (
				((ulong)a.Value & a.ValidMask & b.ValidMask)
				!= ((ulong)b.Value & a.ValidMask & b.ValidMask)
			)
				return Bool3.False;
