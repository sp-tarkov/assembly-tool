...
namespace de4dot.code.AssemblyClient
{
	public abstract class IpcAssemblyServerLoader : IAssemblyServerLoader
	{
		...
		static string GetServerName(ServerClrVersion serverVersion)
		{
			...
			{
				case ServerClrVersion.CLR_ANY_x86:
					return "AssemblyServer.exe";
				case ServerClrVersion.CLR_ANY_x64:
					return "AssemblyServer-x64.exe";
				case ServerClrVersion.CLR_v20_x86:
					return "AssemblyServer-CLR20.exe";
				case ServerClrVersion.CLR_v20_x64:
					return "AssemblyServer-CLR20-x64.exe";
				case ServerClrVersion.CLR_v40_x86:
					return "AssemblyServer-CLR40.exe";
				case ServerClrVersion.CLR_v40_x64:
					return "AssemblyServer-CLR40-x64.exe";
				default:
					throw new ArgumentException($"Invalid server version: {serverVersion}");
			}
		}
		...
		public IAssemblyService CreateService() =>
			(IAssemblyService)Activator.GetObject(AssemblyService.GetType(serviceType), url);
