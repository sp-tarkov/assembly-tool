...
namespace de4dot.code.deobfuscators
{
	public static class DeobUtils
	{
		...
		public static T Lookup<T>(ModuleDefMD module, T def, string errorMessage)
		...
		public static EmbeddedResource GetEmbeddedResourceFromCodeStrings(
			ModuleDef module,
			MethodDef method
		)
		{
		...
		public static bool HasInteger(MethodDef method, uint value) =>
			HasInteger(method, (int)value);

		public static bool HasInteger(MethodDef method, int value) =>
			IndexOfLdci4Instruction(method, value) >= 0;
